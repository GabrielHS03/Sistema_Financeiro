...
public class CidadeDAO {
    ...
    public Cidade save(Cidade usuario) {
    ...
    public Cidade buscarID(Integer ID) {
        ...
        try {
            usuario = entityManager.find(Cidade.class, ID);
        } catch (Exception e) {
            System.err.println(e);
        } finally {
            entityManager.close();
    ...
    public List<Cidade> buscarTodos() {
        ...
        EntityManager entityManager = new ConnectionFactory().getConnection();
        List<Cidade> usuarios = null;

        try {

            usuarios = entityManager.createQuery("from TB_Cidade").getResultList();
